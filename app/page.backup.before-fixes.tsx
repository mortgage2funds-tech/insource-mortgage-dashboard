...
export default function Page() {
  ...
  function onCloseForm(refresh?: boolean) {
    ...
    <main className="mx-auto max-w-7xl p-4 space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="ml-auto text-xs text-gray-500">
          Last updated: {lastUpdatedAt?.replace('T', ' ').replace('Z', '') || '—'}
        </div>
      </div>
                ...
                {clients
                  ...
                  .map((c) => (
                    <div
                      ...
                      style={{ borderColor: draggingId ? '#e5e7eb' : '#e5e7eb' }}
                    >
                      <div className="flex items-center justify-between">
                        <div>
                        ...
                        {/* optional: we can add a small actions icon here later if you want */}
                      </div>
                    </div>
                  ))}
              </div>
